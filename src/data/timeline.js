...
export const timeline = [
  {
    ...
    events: [
      ...
      { month: "Mar", title: "New York visit", description: null, coords: { lat: 40.7128, lng: -74.0060 }, attachments: [img(thumbNyc2026a), img(thumbNyc2026b)] },
      { month: "Feb", title: "Visited Orlando & Kennedy Space Center", description: null, coords: { lat: 28.5729, lng: -80.6490 }, attachments: [img(thumbKsc1), img(thumbOrlando)] },
  ...
  },
  {
    year: "2025",
    events: [
      { month: "Dec", title: "Road trip through the Florida Keys", description: null, coords: route("Road trip through the Florida Keys"), attachments: [img(thumbMiamiKeys), img(thumbMiami2Keys)] },
      ...
      { month: "Sep", title: "Cottage trip in Quebec", description: null, coords: { lat: 46.4171, lng: -75.4782 }, attachments: [img(thumbQuebecCottage)] },
      { month: "Aug", title: "Visited Singapore", description: null, coords: { lat: 1.3521, lng: 103.8198 }, attachments: [img(thumbSingapore1), img(thumbSingapore2)] },
      { month: "Aug", title: "India trip", description: null, coords: { lat: 22.2587, lng: 71.1924 }, attachments: [img(thumbIndia1), img(thumbIndia2)] },
      { month: "Jul", title: "Ran the SF 10k", description: null, coords: { lat: 37.7749, lng: -122.4194 }, attachments: [img(thumbSfRace), img(thumbSfRace2)] },
      { month: "Jun", title: "Went camping in Yosemite", description: null, coords: { lat: 37.8651, lng: -119.5383 }, attachments: [img(thumbYosemite1), img(thumbYosemite3), img(thumbYosemite4), img(thumbYosemite5)] },
      { month: "Jun", title: "Went surfing for the first time", description: null, coords: { lat: 36.9741, lng: -122.0308 }, attachments: [img(thumbSurfing)] },
      { month: "May", title: "Joined Glean", description: null, coords: { lat: 37.4419, lng: -122.1430 }, attachments: [img(thumbGlean1),  note("Built an [automated evals suite for Deep Research ↗](https://www.glean.com/blog/intern-life-at-glean#deep-research)", "yellow"), img(thumbGleanTwinPeaks)], },
  ...
  },
  {
    year: "2024",
    events: [
      { month: "Nov", title: "SF visit", description: null, coords: { lat: 37.7749, lng: -122.4194 }, attachments: [img(thumbSfDatacurve1), img(thumbSfDatacurve2), img(thumbSfDatacurve3)] },
      { month: "Oct", title: "Saw the Attack on Titan musical in New York", description: null, coords: { lat: 40.7128, lng: -74.0060 }, attachments: [img(thumbAotMusical)] },
      { month: "Sep", title: "Joined Expertise.ai", description: null, coords: { lat: 43.6629, lng: -79.3957 }, attachments: [img(thumbExpertiseAi1), img(thumbExpertiseAi2)] },
      { month: "Aug", title: "Visited Vancouver & Seattle", description: null, coords: route("Visited Vancouver & Seattle"), attachments: [img(thumbSeattle1), img(thumbSeattle2)] },
      ...
      { month: "May", title: "Visited Trinidad", description: null, coords: { lat: 10.6918, lng: -61.2225 }, attachments: [img(thumbTrinidad1)] },
      { month: "Mar", title: "Road trip to Boston", description: null, coords: route("Road trip to Boston"), attachments: [img(thumbBoston)] },
  ...
  },
  {
    year: "2023",
    events: [
      { month: "Dec", title: "Visited New York", description: null, coords: { lat: 40.7128, lng: -74.0060 }, attachments: [img(thumbNyc2023c), img(thumbNyc2023b), img(thumbNyc2023a)] },
      { month: "Dec", title: "Attended the Champions Chess Tour 2023", description: null, coords: { lat: 43.6532, lng: -79.383 }, attachments: [img(thumbAmanHambleton), img(thumbEricHansen)] },
      { month: "Sep", title: "Attended TechCrunch Disrupt", description: null, coords: { lat: 37.7749, lng: -122.4194 }, attachments: [img(thumbTechcrunchDisrupt)] },
      { month: "Sep", title: "Attended HackMIT", description: null, coords: { lat: 42.3601, lng: -71.0942 }, attachments: [img(thumbBostonHackmit)] },
  ...
  },
  {
    ...
    events: [
      ...
      { month: "Sept", title: "Started CS @ Waterloo", description: null, coords: { lat: 43.47114661760789, lng: -80.54535675263575 }, attachments: [img(thumbWaterloo)] },
  ...
  },
  {
    year: "2021",
    events: [
      { month: "Aug", title: "Went skydiving", description: null, coords: { lat: 44.3002, lng: -79.5431 }, attachments: [img(thumbSkydiving1), img(thumbSkydiving2), img(thumbSkydiving3)] },
