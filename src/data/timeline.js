...
export const timeline = [
  ...
  },
  {
    ...
    events: [
      ...
      { month: "Aug", title: "Visited Vancouver & Seattle", description: null, coords: [{ lat: 49.2827, lng: -123.1207 }, { lat: 47.6062, lng: -122.3321 }], attachments: [img(seattle1, thumbSeattle1), img(seattle2, thumbSeattle2)] },
      ...
      { month: "Mar", title: "Road trip to Boston", description: null, coords: [{ lat: 43.4723, lng: -79.6903 }, { lat: 42.3601, lng: -71.0589 }], attachments: [img(boston, thumbBoston)] },
